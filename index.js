const contauner = document.getElementsByTagName('img')
contauner[1].addEventListener('click', function() {
...
contauner[2].addEventListener('click', function() {
	document.getElementById("myImage-1").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-2").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-1").src="https://image.flaticon.com/icons/svg/1828/1828970.svg";
	document.getElementById("myImage-2").src="https://image.flaticon.com/icons/svg/1828/1828970.svg";
	document.getElementById("myImage-3").src="https://image.flaticon.com/icons/svg/1828/1828970.svg";
});
...
contauner[4].addEventListener('click', function() {
	document.getElementById("myImage-1").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-2").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-3").src="https://unvegetariano.com/images/star-vector-png-7.png";
...
contauner[5].addEventListener('click', function() {
	document.getElementById("myImage-1").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-2").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-3").src="https://unvegetariano.com/images/star-vector-png-7.png";
	document.getElementById("myImage-4").src="https://unvegetariano.com/images/star-vector-png-7.png";
